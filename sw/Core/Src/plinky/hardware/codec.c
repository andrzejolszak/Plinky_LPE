...
void init_codec(void) {
	...
	wmcodec_write(OUTCTRL, OUTCTRL_HP_COM | OUTCTRL_LINE_COM | OUTCTRL_TSOPCTRL | OUTCTRL_TSDEN | OUTCTRL_VROI);
	...
	wmcodec_write(PWRMGMT2, PWRMGMT2_ROUT1EN | PWRMGMT2_LOUT1EN | PWRMGMT2_BOOSTENL
	                            | PWRMGMT2_BOOSTENR
	...
	wmcodec_write(PWRMGMT3, PWRMGMT3_RMIXEN | PWRMGMT3_LMIXEN | PWRMGMT3_DACENR | PWRMGMT3_DACENL | PWRMGMT3_LOUT2EN
	                            | PWRMGMT3_ROUT2EN | PWRMGMT3_OUT3EN | PWRMGMT3_OUT4EN);
	wmcodec_write(PWRMGMT1,
	              PWRMGMT1_BIASEN | PWRMGMT1_BUFIOEN | PWRMGMT1_VMIDSEL_10K | PWRMGMT1_OUT3MIXEN | PWRMGMT1_OUT4MIXEN);
	...
	wmcodec_write(PWRMGMT1, /*PWRMGMT1_PLLEN | */ PWRMGMT1_BIASEN | PWRMGMT1_BUFIOEN | PWRMGMT1_VMIDSEL_500K
