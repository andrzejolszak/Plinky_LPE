...
const static u16 param_type[NUM_PARAMS] = {
    [P_SHAPE]       = SIGNED,
    [P_DISTORTION]  = UNSIGNED,
    [P_PITCH]       = SIGNED,
    [P_OCT]         = SIGNED + 5,
    [P_GLIDE]       = UNSIGNED,
    [P_INTERVAL]    = SIGNED,
    ...
    [P_RESO]        = UNSIGNED,
    [P_DEGREE]      = SIGNED + 25,
    [P_SCALE]       = UNSIGNED + NUM_SCALES,
    [P_MICROTONE]   = UNSIGNED,
    [P_COLUMN]      = UNSIGNED + 13,
    ...
    [P_DLY_SEND]    = UNSIGNED,
    [P_DLY_TIME]    = SIGNED + 13,
    [P_PING_PONG]   = UNSIGNED,
    [P_DLY_WOBBLE]  = UNSIGNED,
    [P_DLY_FEEDBACK]= UNSIGNED,
    [P_TEMPO]       = SIGNED,

    [P_RVB_SEND]    = UNSIGNED,
    [P_RVB_TIME]    = UNSIGNED,
    [P_SHIMMER]     = UNSIGNED,
    [P_RVB_WOBBLE]  = UNSIGNED,
    [P_RVB_UNUSED]  = 0,
    [P_SWING]       = SIGNED,

    [P_ARP_TGL]     = UNSIGNED + 2,
    [P_ARP_ORDER]   = UNSIGNED + NUM_ARP_ORDERS,
    [P_ARP_CLK_DIV] = SIGNED + NUM_SYNC_DIVS,
    [P_ARP_CHANCE]  = SIGNED,
    [P_ARP_EUC_LEN] = UNSIGNED + 16,
    [P_ARP_OCTAVES] = UNSIGNED + 4,

    [P_LATCH_TGL]   = UNSIGNED + 2,
    [P_SEQ_ORDER]   = UNSIGNED + NUM_SEQ_ORDERS,
    [P_SEQ_CLK_DIV] = UNSIGNED + NUM_SYNC_DIVS + 1,
    [P_SEQ_CHANCE]  = SIGNED,
    [P_SEQ_EUC_LEN] = UNSIGNED + 16,
    [P_GATE_LENGTH] = UNSIGNED,

    [P_SCRUB]       = UNSIGNED,
    [P_GR_SIZE]     = UNSIGNED,
    [P_PLAY_SPD]    = SIGNED,
    [P_SMP_STRETCH] = SIGNED,
    [P_SAMPLE]      = UNSIGNED + NUM_SAMPLES + 1,
    [P_PATTERN]     = UNSIGNED + NUM_PATTERNS,

    [P_SCRUB_JIT]   = UNSIGNED,
    [P_GR_SIZE_JIT] = UNSIGNED,
    [P_PLAY_SPD_JIT]= UNSIGNED,
    [P_SMP_UNUSED1] = 0,
    [P_SMP_UNUSED2] = 0,
    [P_STEP_OFFSET] = SIGNED + 65,

    [P_A_SCALE]     = SIGNED,
    [P_A_OFFSET]    = SIGNED,
    [P_A_DEPTH]     = SIGNED,
    [P_A_RATE]      = SIGNED + NUM_SYNC_DIVS,
    [P_A_SHAPE]     = UNSIGNED + NUM_LFO_SHAPES,
    [P_A_SYM]       = SIGNED,

    [P_B_SCALE]     = SIGNED,
    [P_B_OFFSET]    = SIGNED,
    [P_B_DEPTH]     = SIGNED,
    [P_B_RATE]      = SIGNED + NUM_SYNC_DIVS,
    [P_B_SHAPE]     = UNSIGNED + NUM_LFO_SHAPES,
    [P_B_SYM]       = SIGNED,

    [P_X_SCALE]     = SIGNED,
    [P_X_OFFSET]    = SIGNED,
    [P_X_DEPTH]     = SIGNED,
    [P_X_RATE]      = SIGNED + NUM_SYNC_DIVS,
    [P_X_SHAPE]     = UNSIGNED + NUM_LFO_SHAPES,
    [P_X_SYM]       = SIGNED,

    [P_Y_SCALE]     = SIGNED,
    [P_Y_OFFSET]    = SIGNED,
    [P_Y_DEPTH]     = SIGNED,
    [P_Y_RATE]      = SIGNED + NUM_SYNC_DIVS,
    [P_Y_SHAPE]     = UNSIGNED + NUM_LFO_SHAPES,
    [P_Y_SYM]       = SIGNED,

    [P_SYN_LVL]     = UNSIGNED,
    [P_SYN_WET_DRY] = UNSIGNED,
    [P_HPF]         = UNSIGNED,
    [P_MIX_UNUSED1] = 0,
    [P_SETTINGS1]   = 0,
    [P_VOLUME]      = UNSIGNED,
    ...
    [P_IN_LVL]      = UNSIGNED,
    [P_IN_WET_DRY]  = UNSIGNED,
    [P_SYS_UNUSED1] = 0,
    [P_MIX_UNUSED2] = 0,
    [P_SETTINGS2]   = 0,
    [P_MIX_WIDTH]   = UNSIGNED,
};
